                    ...
                    <tbody>
                        <?php foreach ($resultado as $row) { ?>
                            <tr>
                                ...
                                <td><a href="modificarFromCate.php?id=<?php echo $row['COD_CAT'] ?>" class="btn btn-primary">Editar</a>
                                    <a href="eliminarCategorias.php?id=<?php echo $row['COD_CAT'] ?>" onclick="return confirmarDeleteCategorias()" class="btn btn-success">Borrar</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
